                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="start_date" placeholder="Tarih Giriniz" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="end_date" placeholder="Tarih Giriniz" readonly>
                        </div>
                    </div>
                </div>
                <div>
                    <button id="filter" class="btn btn-outline-info btn-sm">Filtrele</button>
                    <button id="reset" class="btn btn-outline-warning btn-sm">Sıfırla</button>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12">
                        <!-- Table -->
